...
<img src="https://img.shields.io/badge/OPEN_TO_WORK_%C2%B7_PR%C3%81CTICAS-64ffda?style=for-the-badge&labelColor=0a192f" />
...
const sebastian: Developer = {
  ...
  ubicacion:   "Lima, Perú 🇵🇪",
  universidad: "UPC — Ingeniería de Software (7.° ciclo)",
  ranking:     "🏆 Décimo superior (Top 10%)",
  objetivo:    "💼 Prácticas pre-profesionales",
  contacto: {
    email:    "sebastianpariachi.l@gmail.com",
    github:   "https://github.com/SebastianLima-PE",
    linkedin: "https://linkedin.com/in/sebastian-pariachi-limahuaya-4974b0377",
  },
  web:       ["React", "TypeScript", "Node.js", "Express", "MySQL", "MongoDB"],
  movil:     ["Kotlin (Android nativo)", "Flutter", "Swift"],
  practicas: ["DDD", "Arquitectura por capas", "SCRUM", "CI/CD"],
...
- 📱 Desarrollando apps móviles **nativas (Kotlin/Android)** y **multiplataforma (Flutter)**
- 🛠️ Diseñando **APIs RESTful** escalables, documentadas con **Swagger**
...
<img src="https://img.shields.io/badge/Android-3DDC84?style=for-the-badge&logo=android&logoColor=0a192f"/>
...
<img src="https://img.shields.io/badge/Swagger-85EA2D?style=for-the-badge&logo=swagger&logoColor=0a192f"/>
